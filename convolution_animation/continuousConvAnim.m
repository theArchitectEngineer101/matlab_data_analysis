% continuousConvAnim GENERATES AN ANIMATION OF THE CONTINUOUS CONVOLUTION PROCESS.
...
%
%   SYNTAX:
%       y = continuousConvAnim(x_entry_signal, h_impulse_response)
%
%   INPUTS:
...
%       x_signal = ones(1, 20);
%       h_response = exp(-0.2*(0:19));
%
%       % Generate the animation and store the result
%       y_output = continuousConvAnim(x_signal, h_response);
%
%   SEE ALSO:
%       conv, plot, trapz, drawnow
%
